<?php
// File: views/admin/info/tambah.php
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO info_sekolah (judul, kategori, isi_info, tgl_posting) VALUES (?, ?, ?, ?)");
        $stmt->execute([$judul, $kategori, $isi, $tgl]);
...
<html lang="id">
<head>
    <title>Tambah Info | Sikonsel Admin</title>
...
<body class="bg-slate-50 flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="bg-white shadow-sm px-8 py-4 flex justify-between items-center z-10">
            <div>
                <h2 class="text-xl font-bold text-slate-800">Tambah Informasi</h2>
                <p class="text-xs text-slate-400">Buat postingan agenda atau beasiswa baru.</p>
            </div>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <form method="POST" class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="judul" required placeholder="Contoh: Pendaftaran Beasiswa 2026" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select name="kategori" required class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all bg-white">
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl_posting" required value="<?= date('Y-m-d') ?>"
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="isi_info" rows="6" required placeholder="Tuliskan detail lengkap disini..."
